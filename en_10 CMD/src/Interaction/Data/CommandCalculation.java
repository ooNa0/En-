	...
	public String getVersion() {
		...
		try {
			BufferedReader buffer = new BufferedReader(
					new InputStreamReader(new ProcessBuilder(Constant.EXECUTION_COMMAND).start().getInputStream()));
	...
	public String getVolume() {
		...
		try {
			BufferedReader buffer = new BufferedReader(new InputStreamReader(
					new ProcessBuilder(Constant.EXECUTION_COMMAND, "/c", "dir").start().getInputStream()));
