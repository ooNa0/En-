...
public class MainMenu extends JFrame {
	...
	public MainMenu() {
		...
		imageSearchButton = new JButton(Constant.IMAGESEARCH_BUTTON);
		imageSearchButton.setBackground(new Color(255,255,255));
		searchHistoryButton = new JButton(Constant.SHOWRECORD_BUTTON);
		searchHistoryButton.setBackground(new Color(255,255,255));
	}
	public void startMenu() {
		...
		imageSearchButton.setBounds(Constant.FRIST_BUTTON_VERTICAL_POSITION, Constant.BUTTON_HORIZONTAL_POSITION, Constant.BUTTON_HORIZONTAL_SIZE, Constant.BUTTON_VERTICAL_SIZE); //크기 지정
		searchHistoryButton.setBounds(Constant.SECOND_BUTTON_VERTICAL_POSITION, Constant.BUTTON_HORIZONTAL_POSITION, Constant.BUTTON_HORIZONTAL_SIZE, Constant.BUTTON_VERTICAL_SIZE);
